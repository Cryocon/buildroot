...
FLTK_CONF_OPTS += CXXFLAGS=-DFLTK_ABI_VERSION=10303

define FLTK_INSTALL_CONFIG_SCRIPT
        $(INSTALL) -m 0755 -D $(STAGING_DIR)/usr/bin/fltk-config \
                $(HOST_DIR)/usr/bin/fltk-config
endef

FLTK_POST_INSTALL_TARGET_HOOKS += FLTK_INSTALL_CONFIG_SCRIPT
